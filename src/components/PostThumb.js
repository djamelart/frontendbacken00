...
<div className="card">
  <div className="card-body">
    <h5 className="card-title" style={{ color: 'blue' }}>Publications des Personnes non Suivies</h5>
    <p className="card-text">Publications des utilisateurs que vous ne suivez pas encore et dont vous ne recevez pas de notifications.</p>
  </div>
</div>
